...
**FS** = Financial Severity **OS** = Operational Severity **PS** = Privacy Severity **SS** = Safety Severity **ET** = Elapsed Time **E** = Expertise **K** = Knowledge **WO** = Window of Opportunity **EQ** = Equipment Required **APT** = Attack Potential Total **AP** = Attack Probability **CO** = Controllability (Safety) **FR** = Financial Risk **OR** = Operational Risk **PR** = Privacy Risk **SR** = Safety Risk 
